...
#ifdef CONFIG_PRODUCT_REALME_SM6125 //YiXue.Ge@PSW.BSP.Kernel.Stablity, 2018-10-26 add for enable pmic wd
...
#ifdef CONFIG_PRODUCT_REALME_SM6125 /* yanghao@PSW.Kernel.Stability add for debug suspend crash problem */
