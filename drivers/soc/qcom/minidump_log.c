...
#ifdef CONFIG_PRODUCT_REALME_SM6125 //Fanhong.Kong@PSW.BSP.CHG,add 2017/10/10 for O mini dump
...
#ifdef CONFIG_PRODUCT_REALME_SM6125 //yixue.ge@bsp.drv add for dump cpu contex for minidump
