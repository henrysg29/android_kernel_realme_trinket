...
#ifdef CONFIG_PRODUCT_REALME_SM6125//Fanhong.Kong@ProDrv.CHG,add 2018/12/19 for DeathHealer kernel 4.14
...
#if defined(CONFIG_PRODUCT_REALME_SM6125) && defined(CONFIG_OPPO_HEALTHINFO)
...
#if defined(CONFIG_PRODUCT_REALME_SM6125) && defined(CONFIG_DEATH_HEALER)
...
#if defined(CONFIG_PRODUCT_REALME_SM6125)
