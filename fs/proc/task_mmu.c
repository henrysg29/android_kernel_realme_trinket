...
#include "internal.h"
#if defined(CONFIG_PRODUCT_REALME_SM6125) && defined(CONFIG_PROCESS_RECLAIM) && defined(CONFIG_OPPO_SPECIAL_BUILD)
...
static int show_smap(struct seq_file *m, void *v, int is_pid)
{
    ...
    #ifdef CONFIG_PRODUCT_REALME_SM6125 //yixue.ge@bsp.drv modify for android.bg get pss too slow
...
#if defined(CONFIG_PRODUCT_REALME_SM6125) && defined(CONFIG_PROCESS_RECLAIM_ENHANCE)
...
#if defined(CONFIG_PRODUCT_REALME_SM6125) && defined(CONFIG_OPPO_SPECIAL_BUILD)
struct reclaim_info {
...
#endif /* CONFIG_PRODUCT_REALME_SM6125 && CONFIG_OPPO_SPECIAL_BUILD */
