...
#if defined(CONFIG_PRODUCT_REALME_SM6125) && defined(CONFIG_PROCESS_RECLAIM)
...
#ifdef CONFIG_PRODUCT_REALME_SM6125 //yixue.ge@psw.bsp.kernel 20170720 add for add direct_vm_swappiness
/*
...
#ifndef CONFIG_PRODUCT_REALME_SM6125 //yixue.ge@psw.bsp.kernel.driver 20170810 modify for reserver some zram disk size
