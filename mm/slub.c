 ...
 */
#if defined(CONFIG_PRODUCT_REALME_SM6125) && defined(CONFIG_ARM64) && defined(CONFIG_SLUB_DEBUG_ON) && defined(CONFIG_SLUB_DEBUG)
...
#if defined(CONFIG_PRODUCT_REALME_SM6125) && defined(OPPO_SLUB_TRACK)
...
#if defined(CONFIG_SLUB_DEBUG) || (defined(CONFIG_PRODUCT_REALME_SM6125) && defined(CONFIG_SLAB_STAT_DEBUG))
/* Kui.Zhang@PSW.BSP.Kernel.Performance, 2018-11-12, if SLAB_STAT_DEBUG is
  * is enabled, /proc/slabinfo is created for getting more slab details. */
...
#if defined(CONFIG_PRODUCT_REALME_SM6125) && defined(OPPO_SLUB_TRACK) //&& (!defined(CONFIG_SLAB_STAT_DEBUG))
